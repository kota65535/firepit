...
async fn test_vars_required() {
    ...
    let tasks = vec![String::from("inherit"), String::from("cli"), String::from("dependent")];
    ...
    let mut outputs = HashMap::new();
    // Unset var inherits the project var value
    outputs.insert(String::from("#inherit"), String::from("dev"));
